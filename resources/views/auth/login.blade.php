                ...
                <div class="row d-flex justify-content-center align-items-end">
                    <div class="col-sm-12 col-md-4">
                        <div class="left_part">
                            ...
                            <img src="{{ asset('images/com/Homapage/Logo.png') }}" alt="" class="img-fluid mb-3" style="max-width:200px">
                            <img src="{{ asset('images/com/Homapage/Handshake.png') }}" alt="" class="img-fluid d-none d-md-block mb-2 mx-auto" style="max-width:330px">
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <input id="email" type="email" class="form-control " name="email" required
                                    autocomplete="email" autofocus placeholder="Email" class="my-2">

                                <input id="password" type="password" class="form-control my-2" name="password" required
                                ...
                                <div class="d-flex justify-content-start mt-2">
                                    <button type="submit" class="btn btn-primary login_submit pull">
                                        {{ __('Login') }}
                                    </button>
                                </div>
