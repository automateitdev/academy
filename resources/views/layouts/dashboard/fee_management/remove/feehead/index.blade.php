...
<div id="feehead_remove">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="mb-25">
                    <a href="#">Fee Head Remove</a>
                    <!-- <button type="button" class="btn btn-default btn-rounded print pull-right" data-bs-toggle="modal" data-bs-target="#basicsModal">+ Add Information</button> -->
                </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-10 col-md-10 offset-md-1 mt-3">
                <div class="plJhy">
                    <div class="row mt-2">
                        <div class="col-md-8 offset-md-2">
                            ...
                            @endif
                            <div class="rkj">
                                <form action="{{route('feeheadsearch')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                            ...
                            <table class="table table-bordered" id="s_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('feeheadremove', $student->id)}}" class="btn btn-primary">Remove</a>
                                            <a href="{{route('feeheadassign', $student->id)}}" class="btn btn-primary">Reassign</a>
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
