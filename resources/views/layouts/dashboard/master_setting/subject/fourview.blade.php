...
<div id="four_subject">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="mb-25">
                    <a href="{{route('fourthsubject.index')}}">Assign : All Subject</a> 
                    <a href="{{route('fourthsubject.index')}}" class="btn btn-default btn-rounded print pull-right">Back</a>
                ...
                <form action="{{route('foursubjectupdate')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="rkj">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col">
                                <input type="text" disabled="true" class="form-control" value="{{$stdSubMap->subjecttype->name}}">
                            </div>
                        </div>
