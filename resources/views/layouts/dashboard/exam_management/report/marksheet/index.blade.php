    ...
    <div id="tabulation">
        <div class="container">
            ...
            <div class="row mt-3">
                ...
                @if(isset($students) && isset($std_subject_map))
                            ...
                            @foreach ($std_subject_map->sortBy('student_id')->unique('student_id') as $stdSubjectMap)
                                @foreach ($students as $student)
                                    @if ($stdSubjectMap->student_id == $student->std_id && $stdSubjectMap->institute_id == Auth::user()->institute_id)
                                        ...
                                        <tr>
                                                <input type="hidden" value="{{ $class_id }}" name="class_id{{$stdSubjectMap->student_id}}" id="class_id{{$stdSubjectMap->student_id}}">
                                                <input type="hidden" value="{{ $group_id }}" name="group_id{{$stdSubjectMap->student_id}}" id="group_id{{$stdSubjectMap->student_id}}">
                                                <input type="hidden" value="{{ $group_name }}" name="group_name{{$stdSubjectMap->student_id}}" id="group_name{{$stdSubjectMap->student_id}}">
                                                <input type="hidden" value="{{ $session_name }}" name="session_name{{$stdSubjectMap->student_id}}" id="session_name{{$stdSubjectMap->student_id}}">
                                                <input type="hidden" value="{{ $examstartup_id }}" name="examstartup_id{{$stdSubjectMap->student_id}}" id="examstartup_id{{$stdSubjectMap->student_id}}">
                                                <input type="hidden" value="{{ $academic_year_id }}" name="academic_year_id{{$stdSubjectMap->student_id}}" id="academic_year_id{{$stdSubjectMap->student_id}}">
