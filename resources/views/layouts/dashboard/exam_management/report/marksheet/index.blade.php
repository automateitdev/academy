            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $student->roll }}</td>
                        <td>
                            <button class="btn btn-sm btn-primary markProcess" id={{$stdSubjectMap->student_id}}>Process</button> 
                            <button class="btn btn-sm btn-dark marksheet_{{$stdSubjectMap->student_id}}" disabled="true" id="">Download</button>
                        </td>
                    </tr>
                    @endif
                    @endforeach
